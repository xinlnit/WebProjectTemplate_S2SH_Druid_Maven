...
public class LoginController extends ActionSupport{
	...
	public String adminLogin(){	
		...
		//List<Admin> list = this.adminService.showAllAdmin();
		//this.admin = list.get(0);
		System.out.println("用户名:"+admin.getName()+";账号:"+admin.getAccountManage().getAccount()+"密码:"+admin.getAccountManage().getPassword());
		if(admin!=null){
